<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>Date,Temperature,Humidity
<%
...
while (rowSet.next()) {
    ...
    out.print(",");
    out.print(rowSet.getString("temperature"));
    out.print(",");
    out.print(rowSet.getString("humidity"));
    out.println();
}
%>